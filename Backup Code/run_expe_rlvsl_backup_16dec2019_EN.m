...
%
% Version Note: The state of the code before changing the script to French. 
%
...
function key_training
    ...
    key_rec0r = CenterRectOnPoint(Screen('TextBounds',video.h,key_prac0r),video.x/2+shape_off*2.2,video.y/2);
