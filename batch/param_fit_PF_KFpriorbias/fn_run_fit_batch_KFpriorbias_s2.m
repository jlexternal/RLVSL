function fn_run_fit_batch_KFpriorbias_s2(ibatch)
...
savename = sprintf('out_fit_KFpriorbias_%s_%s%s%s_%d_%02d_2',bias_type,cfg.cscheme(1),cfg.lscheme(1),cfg.nscheme(1),nbatch,isubj);
