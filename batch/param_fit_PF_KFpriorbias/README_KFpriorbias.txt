Batch model parameter recovery for unbiased KF model with variable upper and lower asymptotes (RLVSL)
...
-----------------------
1/ fn_run_fit_batch_KFunbiased.m
...
2/ launch-slurm_run_fit_batch_KFunbiased.sh
...
4/ Send batch requests on SLURM using sbatch launch-slurm_run_fit_batch_KFunbiased.sh
