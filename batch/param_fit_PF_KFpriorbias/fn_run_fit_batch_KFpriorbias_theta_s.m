function fn_run_fit_batch_KFpriorbias_theta_s(ibatch)
...
savename = sprintf('out_fit_KFpriorbias_theta_%s_%s%s%s_%d_%02d',bias_type,cfg.cscheme(1),cfg.lscheme(1),cfg.nscheme(1),nbatch,isubj);
