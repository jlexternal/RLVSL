function fn_run_fit_batch_KFepsibias_theta_c(ibatch)
...
% ------------------ model options ------------------
%cfg.epsi       = 0; fit epsi
cfg.sbias_cor   = true; % assume bias toward correct response
cfg.sbias_ini   = false;
%cfg.theta       = 0; % fit softmax
...
savename = sprintf('out_fit_KFepsibias_theta_%s_%s%s%s_%d_%02d',epsibias_type,cfg.cscheme(1),cfg.lscheme(1),cfg.nscheme(1),nbatch,isubj);
